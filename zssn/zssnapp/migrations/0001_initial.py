    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_do_registro', models.DateTimeField(auto_now_add=True)),
                ('sobrevivente_negociador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sobreviventeNegociador', to='zssnapp.sobrevivente')),
                ('sobrevivente_receptor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sobreviventeReceptor', to='zssnapp.sobrevivente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_do_registro', models.DateTimeField(auto_now_add=True)),
                ('sobrevivente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inventarioDoSobrevivente', to='zssnapp.sobrevivente')),
            ],
        ),
        migrations.CreateModel(
            name='Infectados',
